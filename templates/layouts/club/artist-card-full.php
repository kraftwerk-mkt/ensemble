<?php
/**
 * Template: Club Artist Card - Full
 * Card style with image, name, genre tags, bio and button
...
if (!empty($genre)) {
    ...
    $genre_names = array_map('trim', explode(',', $genre));
...
<article class="ensemble-artist-card es-club-card es-club-artist-card-full">
    
    <!-- Image Header -->
    <a href="<?php echo esc_url($permalink); ?>" class="es-club-card-image-link" <?php echo $link_target === '_blank' ? 'target="_blank" rel="noopener"' : ''; ?>>
        <div class="es-club-card-image">
            <?php if ($image): ?>
    ...
    <!-- Content -->
    <div class="es-club-card-content">
        
        <!-- Name -->
        <h3 class="es-club-title">
        ...
        <div class="es-club-genre-tags">
            ...
            <span class="es-club-genre-tag"><?php echo esc_html($g); ?></span>
            <?php endforeach; ?>
        </div>
        <?php endif; ?>
        ...
        <p class="es-club-excerpt"><?php echo esc_html(wp_trim_words($excerpt, 15)); ?></p>
        <?php endif; ?>
        
        <!-- Button -->
        <?php if ($show_link): ?>
        <a href="<?php echo esc_url($permalink); ?>" 
           class="es-club-btn es-club-btn-outline"
