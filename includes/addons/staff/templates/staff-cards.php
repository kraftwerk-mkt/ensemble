...
<div class="es-staff-cards-wrapper">
    <div class="es-staff-cards es-staff-cards--cols-<?php echo esc_attr($columns); ?>">
                ...
                <div class="es-staff-card-item__inner">
                    <div class="es-staff-card-item__front">
                        ...
                        <div class="es-staff-card-item__info">
                            <h3 class="es-staff-card-item__name" itemprop="name">
                                <?php echo esc_html($person['name']); ?>
                            </h3>
                            
                            <?php if ($show_position && !empty($person['position'])) : ?>
                                <p class="es-staff-card-item__position" itemprop="jobTitle">
                    ...
                    <div class="es-staff-card-item__back">
                        <div class="es-staff-card-item__back-content">
                            <h3 class="es-staff-card-item__name">
                                <?php echo esc_html($person['name']); ?>
                            </h3>
                            ...
                            <a href="<?php echo esc_url($person['permalink']); ?>" class="es-staff-card-item__link">
