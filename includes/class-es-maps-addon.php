...
class ES_Maps_Addon extends ES_Addon_Base {
     ...
     * 
     * @param bool $force Force loading without page checks (used by Gutenberg blocks)
     */
    public function enqueue_frontend_assets($force = false) {
        // Skip page checks if forced (e.g., from Block render)
        if (!$force) {
